...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        self,
        sample: torch.FloatTensor,
        conditioning_hidden_states: torch.FloatTensor,
        ...
        num_frames_c = conditioning_hidden_states.shape[2]
        ...
        h_emb = self.hidden_time_embedding(t_emb, timestep_cond)
        ...
        sample, conditioning_hidden_states = self.conv_in(sample, conditioning_hidden_states=conditioning_hidden_states)
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            conditioning_hidden_states_res_samples = down_block_res_conditioning_hidden_states[-len(upsample_block.resnets) :]
            down_block_res_conditioning_hidden_states = down_block_res_conditioning_hidden_states[: -len(upsample_block.resnets)]
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample, conditioning_hidden_states = upsample_block(
                    hidden_states=sample,
        ...
        sample, conditioning_hidden_states = self.conv_out(sample, conditioning_hidden_states=conditioning_hidden_states)
