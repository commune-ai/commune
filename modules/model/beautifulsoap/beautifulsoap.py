...
import urllib
import os
from commune..model.beautifulsoap.random_website.random_website import generate_random_ip, \
    get_domain, check_webapp, get_text_content, generate_random_website_url, is_valid_website
from commune..model.openai.model_openai import OpenAILLM
from commune..model.beautifulsoap.google_search.google_search import google_search, google_search_with_api
...
class BeautifulSoapModule(c.Module):
    ...
    def image_scrap(self, url):
        from commune..model.beautifulsoap.image_fetcher.image_fetcher import setup_fetcher
