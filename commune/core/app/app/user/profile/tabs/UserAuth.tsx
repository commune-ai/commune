...
export const UserAuth = ({ keyInstance }: UserAuthProps) => {
  ...
  useEffect(() => {
    if (keyInstance) {
      const auth = new Auth(keyInstance, cryptoType, 'sha256', maxStaleness)
      setAuthInstance(auth)
    }
  }, [keyInstance, cryptoType, maxStaleness])
          ...
          <div className="mt-4 space-y-3">
            <div className="p-3 bg-green-500/5 rounded border border-green-500/20">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  onClick={() => copyToClipboard(formatHeaders(authHeaders), 'headers')}
