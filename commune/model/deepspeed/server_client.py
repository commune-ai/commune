...
class MIIServerClient():
    ...
    def __init__(self,
                 ...
                 initialize_grpc_client=False,
                 use_grpc_server=False):


        print('MII LOCAL VARIABLES ',dict(locals()))
    ...
    def _initialize_service(self,
        ...
        if not self.use_grpc_server:
            self.model = self.load_models(task_name=mii.utils.get_task_name(
                self.task),
                                                ...
                                                provider=mii.constants.ModelProvider.HUGGING_FACE,
    ...
    def load_models(task_name,
        ...
        print('local_rank', local_rank, 'world size', world_size)
