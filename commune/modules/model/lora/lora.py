...
class LoraModel(Model):
    def __init__(self, base_model_name):
        ...
        # Model
        self.init_base_model(base_model_name=base_model_name)
    ...
    def init_base_model(self, base_model_name='TheBloke/Llama-2-7b-chat-fp16'):
    ...
    def config_lora(self, alpha=64, dropout=0.05, r=32, bias='none', task_type='CAUSAL_LM'):
        self.lora_config = LoraConfig(lora_alpha=alpha,
    ...
    def train(self, dataset_name, output_path, data_prep_func, num_epochs=1):
