...
class DreamBooth(c.Module):
    ...
    def train(cls, *args, **kwargs):
        ...
        train_dataloader = torch.utils.data.DataLoader(
            ...
            shuffle=True,
            collate_fn=lambda examples: self.collate_fn(examples, args.with_prior_preservation),
    ...
    @classmethod
    def snapshot_download(cls, local_dir='./dog', path= "diffusers/dog-example", repo_type='dataset', ignore_patterns='.gitattributes'):
    ...
    def save_model_card(repo_id: str, images=None, base_model=str, prompt=str, repo_folder=None):
        ...
        ---
        """
        model_card = f"""# LoRA DreamBooth - {repo_id}
