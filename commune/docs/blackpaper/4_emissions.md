...
We approximate the yumaswap by incentivizing early staking. This is done by calculating the slope of the square root of the stake as a cumulative distribution multiplied by their tokens.

This is done by tracking when 