...
fn test_registration_add_network_size() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(SubtensorModule::get_subnet_n(netuid), 0);

		add_network(netuid2, 13, 0);
		assert_eq!(SubtensorModule::get_subnet_n(netuid2), 0);
		...
		assert_eq!(SubtensorModule::get_subnet_n(netuid2), 2);
...
fn test_full_pass_through() {
	new_test_ext().execute_with(|| {
		...
		assert_eq!(SubtensorModule::get_subnet_n(netuid0), 0);
		assert_eq!(SubtensorModule::get_subnet_n(netuid1), 0);
		assert_eq!(SubtensorModule::get_subnet_n(netuid2), 0);
		...
		assert_eq!(SubtensorModule::get_subnet_n(netuid0), 2);
		assert_eq!(SubtensorModule::get_subnet_n(netuid1), 2);
		assert_eq!(SubtensorModule::get_subnet_n(netuid2), 2);
