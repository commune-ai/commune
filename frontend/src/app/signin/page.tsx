                ...
                <div className="w-full p-8 md:w-1/2">
                    ...
                    <form name="loginForm" noValidate onSubmit={handleSubmit} className="mt-8 flex flex-col">
                        <Input
                            ...
                            className="mb-4 dark:text-black rounded-lg p-2"
                        />
                        <Input.Password
                            placeholder="Password"
                            value={password}
                            onChange={handlePasswordChange}
                            className="mb-4 dark:text-black p-2"
                            status={passwordError ? 'error' : ''}
                        />
                        {passwordError && <Text type="danger">{passwordError}</Text>}
                        <div className="flex justify-between items-center mt-4">
                            <Checkbox value={remember} onChange={({ target: { value } }) => setRemember(value)} className=' dark:text-white'>Remember me</Checkbox>
                            <a className="text-blue-500" href="/pages/auth/forgot-password">Forgot password?</a>
                        </div>
                        <Button
                            type="primary"
                            htmlType="submit"
                            className="mt-4 w-full dark:text-white flex items-center justify-center p-5"
