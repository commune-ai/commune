...
_SYNAPSE_SYNAPSETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GENERAL_JSON', index=5, number=5,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_SYNAPSE_GENERALJSON = _descriptor.Descriptor(
  name='GeneralJSON',
  full_name='Synapse.GeneralJSON',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='synapse_type', full_name='Synapse.GeneralJSON.synapse_type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='forward_request_serializer_type', full_name='Synapse.GeneralJSON.forward_request_serializer_type', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='forward_response_serializer_type', full_name='Synapse.GeneralJSON.forward_response_serializer_type', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='backward_request_serializer_type', full_name='Synapse.GeneralJSON.backward_request_serializer_type', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='backward_response_serializer_type', full_name='Synapse.GeneralJSON.backward_response_serializer_type', index=4,
      number=5, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='requires_grad', full_name='Synapse.GeneralJSON.requires_grad', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SYNAPSE = _descriptor.Descriptor(
  ...
  nested_types=[_SYNAPSE_TEXTLASTHIDDENSTATE, _SYNAPSE_TEXTCAUSALLM, _SYNAPSE_TEXTSEQ2SEQ, _SYNAPSE_TEXTCAUSALLMNEXT, _SYNAPSE_GENERALJSON, ],
  enum_types=[
...
_SYNAPSE_GENERALJSON.fields_by_name['synapse_type'].enum_type = _SYNAPSE_SYNAPSETYPE
_SYNAPSE_GENERALJSON.fields_by_name['forward_request_serializer_type'].enum_type = _SERIALIZER
_SYNAPSE_GENERALJSON.fields_by_name['forward_response_serializer_type'].enum_type = _SERIALIZER
_SYNAPSE_GENERALJSON.fields_by_name['backward_request_serializer_type'].enum_type = _SERIALIZER
_SYNAPSE_GENERALJSON.fields_by_name['backward_response_serializer_type'].enum_type = _SERIALIZER
_SYNAPSE_GENERALJSON.containing_type = _SYNAPSE
...
Synapse = _reflection.GeneratedProtocolMessageType('Synapse', (_message.Message,), dict(
  ...
  TextLastHiddenState = _reflection.GeneratedProtocolMessageType('TextLastHiddenState', (_message.Message,), dict(
  ...
  TextCausalLM = _reflection.GeneratedProtocolMessageType('TextCausalLM', (_message.Message,), dict(
  ...
  TextSeq2Seq = _reflection.GeneratedProtocolMessageType('TextSeq2Seq', (_message.Message,), dict(
  ...
  TextCausalLMNext = _reflection.GeneratedProtocolMessageType('TextCausalLMNext', (_message.Message,), dict(
  ...
  GeneralJSON = _reflection.GeneratedProtocolMessageType('GeneralJSON', (_message.Message,), dict(
    DESCRIPTOR = _SYNAPSE_GENERALJSON,
    __module__ = 'bittensor_pb2'
    # @@protoc_insertion_point(class_scope:Synapse.GeneralJSON)
    ))
  ,
  DESCRIPTOR = _SYNAPSE,
  __module__ = 'bittensor_pb2'
...
_sym_db.RegisterMessage(Synapse.GeneralJSON)
