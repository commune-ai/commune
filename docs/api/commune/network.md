...
##### `add_server(self, name: str, address: str, key: str) -> None`
...
##### `addresses(self, *args, **kwargs) -> List[str]`
...
##### `modules(self, search=None, max_age=60, update=False, features=['name', 'address', 'key'], timeout=8, **kwargs)`
...
##### `names(self, *args, **kwargs) -> List[str]`
...
##### `namespace(self, search=None, max_age: int = 60, update: bool = False, **kwargs) -> dict`
...
##### `register_from_signature(self, signature=None)`



##### `remove_server(self, name: str, features=['name', 'key', 'address']) -> Dict`
...
##### `resolve_network(self, network: str) -> str`
...
##### `server_exists(self, name: str, **kwargs) -> bool`
...
##### `servers(self, search=None, **kwargs) -> List[str]`
...
##### `set_network(self, network: str, tempo: int = 60, path=None, **kwargs)`
