...
### `available_ports(port_range: List[int] = None, ip: str = None) -> int`



Type annotations:
```python
port_range: typing.List[int]
ip: <class 'str'>
return: <class 'int'>
```
...
### `check_used_ports(start_port=8501, end_port=8600, timeout=5)`
...
### `cmd(command: Union[str, list], *args, verbose: bool = False, env: Dict[str, str] = {}, sudo: bool = False, password: bool = None, bash: bool = False, return_process: bool = False, stream: bool = False, color: str = 'white', cwd: str = None, **kwargs) -> 'subprocess.Popen'`
...
### `external_ip(default_ip='0.0.0.0') -> str`
...
### `format_data_size(x: Union[int, float], fmt: str = 'b', prettify: bool = False)`
...
### `free_port(ports=None, port_range: List[int] = None, ip: str = None, avoid_ports=None, random_selection: bool = True) -> int`
...
port_range: typing.List[int]
ip: <class 'str'>
random_selection: <class 'bool'>
return: <class 'int'>
```

### `free_ports(n=10, random_selection: bool = False, **kwargs) -> List[int]`
...
### `get_available_port(ports=None, port_range: List[int] = None, ip: str = None, avoid_ports=None, random_selection: bool = True) -> int`
...
### `get_available_ports(port_range: List[int] = None, ip: str = None) -> int`
...
### `get_port_range(port_range: list = None) -> list`



Type annotations:
```python
port_range: <class 'list'>
return: <class 'list'>
```
...
### `get_used_ports(ports: List[int] = None, ip: str = '0.0.0.0', port_range: Tuple[int, int] = None)`
...
ip: <class 'str'>
port_range: typing.Tuple[int, int]
```
...
### `gpu_info(fmt='gb') -> Dict[int, Dict[str, float]]`



Type annotations:
```python
return: typing.Dict[int, typing.Dict[str, float]]
```
...
### `ip(max_age=None, update: bool = False, **kwargs) -> str`
...
### `is_port_public(port: int, ip: str = None, timeout=0.5)`
...
Kills a process running on the passed port.
Args:
...
### `kill_ports(ports=None, *more_ports)`
...
### `port_available(port: int, ip: str = '0.0.0.0')`
...
### `port_used(port: int, ip: str = '0.0.0.0', timeout: int = 1)`
...
### `public_ports(timeout=1.0)`



### `random_port(*args, **kwargs)`



### `resolve_ip(ip=None, external: bool = True) -> str`
...
### `resolve_port(port: int = None, **kwargs)`
...
### `resolve_port_range(port_range: list = None) -> list`
...
### `set_port_range(*port_range: list)`
...
### `unreserve_port(port: int, var_path='reserved_ports')`
...
### `unreserve_ports(*ports, var_path='reserved_ports')`



### `used_ports(ports: List[int] = None, ip: str = '0.0.0.0', port_range: Tuple[int, int] = None)`
