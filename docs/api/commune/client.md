...
##### `forward(self, fn='info', params: Union[list, dict, NoneType] = None, args: Optional[list] = [], kwargs: Optional[dict] = {}, timeout: int = 2, key: str = None, mode: str = 'http', headers=None, stream: bool = False)`



Type annotations:
```python
params: typing.Union[list, dict, NoneType]
...
##### `get_data(self, args=[], kwargs={}, params=None)`



##### `get_header(self, data, key: 'Key')`
...
##### `process_stream_line(self, line, stream_prefix='data: ')`



##### `resolve_key(self, key=None)`
...
##### `test(self, module='module::test_client')`
