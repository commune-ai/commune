...
Source: `commune/modules/app/app.py`
...
##### `app(self, module: str = 'server', name: Optional[str] = None, fn: str = 'app', port: int = None, remote: bool = False, kwargs: dict = None, cmd=None, update: bool = False, process_name: str = None, cwd=None)`
...
##### `app_exists(self, name)`



##### `app_modules(self, **kwargs)`



##### `apps(self, remove_prefix=True)`
...
##### `filter_name(self, name: str) -> bool`
...
##### `get_free_port(self, module, port=None, update=False)`
...
##### `resolve_process_name(self, name)`
...
##### `start(self, module: str = 'server', name: Optional[str] = None, fn: str = 'app', port: int = None, remote: bool = False, kwargs: dict = None, cmd=None, update: bool = False, process_name: str = None, cwd=None)`
...
##### `start_app(self, module: str = 'server', name: Optional[str] = None, fn: str = 'app', port: int = None, remote: bool = False, kwargs: dict = None, cmd=None, update: bool = False, process_name: str = None, cwd=None)`
