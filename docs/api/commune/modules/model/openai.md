...
Source: `commune/modules/model/openai.py`
...
##### `call(self, prompt: str = 'sup?', model: str = 'gpt-4-vision-preview', presence_penalty: float = 0.0, frequency_penalty: float = 0.0, temperature: float = 0.9, max_tokens: int = 4096, top_p: float = 1, choice_idx: int = 0, api_key: str = None, role: str = 'user', history: list = None, stream=False, **kwargs) -> str`
...
prompt: <class 'str'>
model: <class 'str'>
presence_penalty: <class 'float'>
frequency_penalty: <class 'float'>
temperature: <class 'float'>
max_tokens: <class 'int'>
top_p: <class 'float'>
choice_idx: <class 'int'>
api_key: <class 'str'>
role: <class 'str'>
history: <class 'list'>
return: <class 'str'>
...
##### `forward(self, prompt: str = 'sup?', model: str = 'gpt-4-vision-preview', presence_penalty: float = 0.0, frequency_penalty: float = 0.0, temperature: float = 0.9, max_tokens: int = 4096, top_p: float = 1, choice_idx: int = 0, api_key: str = None, role: str = 'user', history: list = None, stream=False, **kwargs) -> str`
...
##### `generate(self, prompt: str = 'sup?', model: str = 'gpt-4-vision-preview', presence_penalty: float = 0.0, frequency_penalty: float = 0.0, temperature: float = 0.9, max_tokens: int = 4096, top_p: float = 1, choice_idx: int = 0, api_key: str = None, role: str = 'user', history: list = None, stream=False, **kwargs) -> str`
...
##### `resolve_prompt(self, *args, prompt=None, **kwargs)`
