...
Source: `commune/modules/agent/history.py`
...
##### `check_item(self, item, required_fields=['address', 'timestamp'])`
...
##### `get_user_directory(self, key)`



##### `get_user_path(self, key_address)`
...
##### `history_exists(self, key)`



##### `history_size(self, key)`
